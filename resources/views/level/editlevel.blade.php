          ...
          <div class="row">
            <div class="text-center">
              <form action="{{ url('/admin/editlevel') }}" method="post">
                ...
                @php
                $result = isset($upMoney) ? $upMoney->level_threshold : '';
                @endphp
                <input id="upMoney" name="upMoney" type="hidden"  class="form-control  " value="{{$result}}" required=""> 
                @php
                $result2 = isset($downMoney) ? $downMoney->level_threshold : '';
                @endphp
                <input id="downMoney" name="downMoney" type="hidden"  class="form-control  " value="{{$result2}}" required=""> 
                ...
                <div>
                  <a class="btn btn-sm btn-default" href="{{ url('/admin/level') }}">{{__('shop.Back')}}</a>
                </div>
              </div>
          </div>
        </div>
